...
| `version/1.19.2` | 1.19.2 | 17 | Paper/Purpur, Fabric, Forge | experimental scaffold; Java 17 lane build is pinned and isolated |
| `version/1.18.2` | 1.18.2 | 17 | Paper/Purpur, Fabric, Forge | planned; separate Java 17 lane pending |
