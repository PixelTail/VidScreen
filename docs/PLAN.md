...
- the 1.19.2 Java 17 feasibility lane now has an isolated Gradle 8.6 scaffold for Fabric, Forge, and Paper with bounded legacy transport adapters; its exact build and all runtime gates remain pending CI verification, so it is not a support claim.
