...
public final class VidScreenFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(VidScreenPayload.ID, (payload, context) -> {
            try {
    ...
    private static void tick() {
        ...
        if (now < nextClockSampleMillis || !ClientPlayNetworking.canSend(VidScreenPayload.ID)) {
            return;
        }
