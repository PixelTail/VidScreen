...
final class ScreenTextureManager implements AutoCloseable {
    ...
    ResourceLocation texture(UUID id) {
    ...
    private static Entry create(UUID id, MediaDescriptor media, int width, int height) {
        ResourceLocation location = new ResourceLocation("vidscreen", "screen/" + id.toString().replace("-", ""));
    ...
    private void remove(UUID id) {
        ...
        if (removed != null) {
            ...
            manager.release(removed.location);
        }
    }
    ...
    private static final class Entry {
        ...
        private Entry(ResourceLocation location, MediaDescriptor media, DynamicTexture texture,
